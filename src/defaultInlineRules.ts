...
defaultInlineRules.set(footnoteRule.name, footnoteRule);
defaultInlineRules.set(superscriptRule.name, superscriptRule);
defaultInlineRules.set(imageRule.name, imageRule);
